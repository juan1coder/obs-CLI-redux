...
```
cd existing_repo
git remote add origin https://gitlab.com/yonnlopez/obs-cli-redux.git
git branch -M main
...
- [ ] [Set up project integrations](https://gitlab.com/yonnlopez/obs-cli-redux/-/settings/integrations)
